...
void Texture::ColourModulation(const SDL_Colour& colour)
{
    ColourModulation(colour.r, colour.g, colour.b);
}

void Texture::ColourModulation(Uint8 r, Uint8 g, Uint8 b)
{
...
SDL_Texture* Texture::DuplicateTexture()
{
    return DuplicateSDLTexture(m_renderer_ptr, m_texture_ptr);
}

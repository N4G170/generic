...
namespace sdl_gui
{
    ...
    class ContainerBox: public GuiElement, public IGuiInteraction, public IGuiRender
    {
        public:
            /* Default constructor */
            ContainerBox(SDL_Renderer* renderer_ptr, ResourceManager* resource_manager_ptr, Position position, Dimensions dimensions);
            /* Default destructor */
             ...
             */
            void AddElement(GuiElement* element, IGuiRender* renderable, IGuiInteraction* interactable = nullptr);
            //</f>
        ...
        private:
            ...
            std::vector<IGuiRender*> m_gui_renderable;
            std::vector<IGuiInteraction*> m_gui_interactables;

...
//
// Xeno::Xeno():Planet(), m_rotation_sin{static_cast<float>(sin(xeno_orbit_rotation_angle))}, m_rotation_cos{static_cast<float>(cos(xeno_orbit_rotation_angle))}
// {
//
// }
//
// void Xeno::Logic(float fixed_frame_time)
// {
